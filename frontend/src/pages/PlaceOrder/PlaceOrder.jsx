...
const PlaceOrder = () => {
  ...
  const placeOrder = async (event) => {
    ...
    const orderData = {
      userId,             // <== VERY IMPORTANT: pass userId!
      address: data,
      items: orderItems,
      amount: getTotalCartAmount(), // subtotal only, backend will add delivery + tax
      paymentMethod,
    };
    ...
    <form onSubmit={placeOrder} className="place-order">
      ...
      <div className="place-order-right">
        <div className="cart-total">
          ...
          <button className="proceed" type="submit" disabled={loading}>
